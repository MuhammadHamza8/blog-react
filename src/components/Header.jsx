...
<ul className=" gap-x-12 xs:hidden flex sm:flex  md:flex lg:flex  xl:flex  2xl:flex  ">
...
<ul id="nav" className="flex gap-x-12 xs:block  sm:hidden  md:hidden lg:hidden xl:hidden  2xl:hidden ">
    <Link to="/" > <li className="font-serif">BLOG</li></Link>
    <Link to="/about" > <li className="font-serif">ABOUT</li></Link>
    <Link to="/projects"> <li className="font-serif">PROJECTS</li></Link>
</ul>
